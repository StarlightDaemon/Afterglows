const coronagraphStyles = `
  ...
  /* Solar corona plasma streamers radiating beyond occulting disc */
  .co-corona-streamers {
    animation: co-corona-pulse 2.8s ease-in-out infinite alternate;
    transform-origin: 38px 36px;
  }

  @keyframes co-corona-pulse {
    0% { transform: scale(0.92) rotate(-2deg); opacity: 0.7; }
    100% { transform: scale(1.08) rotate(2deg); opacity: 1; filter: drop-shadow(0 0 4px #00e5ff); }
  }

  /* Artificial eclipse occulting cone mask alignment */
  .co-occulting-cone {
    animation: co-cone-steady 2s ease-in-out infinite alternate;
    transform-origin: 38px 36px;
  }

  @keyframes co-cone-steady {
    0% { transform: scale(0.99); }
    100% { transform: scale(1.01); }
  }

  /* Lyot diffraction stop ring blocking scattered aperture ring light */
  .co-lyot-stop {
      ...
      <div class="co-box">
        <div class="co-stage">
          <svg class="co-svg" viewBox="0 0 76 72">
            ...
            <line x1="12" y1="26" x2="12" y2="46" stroke="#00e5ff" stroke-width="2" stroke-linecap="round" />

            <!-- Converging Solar Focus Beam -->
            <polygon points="12,26 38,36 12,46" fill="rgba(255, 235, 59, 0.15)" stroke="none" />
            ...
            <g class="co-corona-streamers">
              ...
              <path d="M 38 24 Q 44 16 52 14" fill="none" stroke="#69f0ae" stroke-width="1.2" />
              <path d="M 44 32 Q 54 28 62 26" fill="none" stroke="#00e5ff" stroke-width="1.4" />
              <path d="M 44 40 Q 56 44 64 46" fill="none" stroke="#00e5ff" stroke-width="1.4" />
              <path d="M 38 48 Q 44 56 50 58" fill="none" stroke="#69f0ae" stroke-width="1.2" />
              <!-- Hydrogen-Alpha Red Solar Prominence Loops -->
              <path d="M 36 26 Q 34 20 38 20 Q 42 20 40 26" fill="none" stroke="#ff5252" stroke-width="1.2" />
            </g>

            <!-- Mirrored Occulting Cone Disk (Creates artificial total solar eclipse) -->
            <g class="co-occulting-cone">
              <!-- Dark Occulting Shadow Disc -->
              <circle cx="38" cy="36" r="8.5" fill="#05080e" stroke="#ff5252" stroke-width="0.6" />
              <!-- Mirrored Deflection Cone Tip reflecting fierce photospheric heat out side port -->
              <polygon points="38,36 34,32 34,40" fill="#ffd700" />
            </g>

            <!-- Field Lens & Lyot Stop Diaphragm (Blocks diffracted light from objective edge) -->
            <g class="co-lyot-stop">
              <line x1="52" y1="26" x2="52" y2="31" stroke-width="1.6" />
              <line x1="52" y1="41" x2="52" y2="46" stroke-width="1.6" />
            </g>

            <!-- Camera Focus Lens (Right) -->
            <line x1="62" y1="28" x2="62" y2="44" stroke="#80d8ff" stroke-width="1.5" />
