const geodeBandingStyles = `
  ...
  /* Concentric agate rings color breathing */
  .gb-ring-1 { fill: #4a148c; stroke: #7b1fa2; stroke-width: 0.8; }
  .gb-ring-2 { fill: #6a1b9a; stroke: #9c27b0; stroke-width: 0.8; }
  .gb-ring-3 { fill: #8e24aa; stroke: #ba68c8; stroke-width: 0.8; }
  .gb-ring-4 { fill: #ab47bc; stroke: #ce93d8; stroke-width: 0.8; }

  /* Central amethyst drusy crystal sparkle */
  .gb-amethyst polygon {
    fill: #e1bee7;
    stroke: #ffffff;
    stroke-width: 0.6;
    animation: gb-crystal-sparkle 2.5s ease-in-out infinite alternate;
  }

  .gb-amethyst polygon:nth-child(2n) {
    animation-delay: 0.8s;
  }

  .gb-amethyst polygon:nth-child(3n) {
    animation-delay: 1.6s;
  }

  @keyframes gb-crystal-sparkle {
    0% { fill: #ba68c8; filter: drop-shadow(0 0 1px #7b1fa2); }
    100% { fill: #ffffff; filter: drop-shadow(0 0 4px #e040fb); }
  }

  /* Mineral fluid infiltration shimmer */
  .gb-crust {
    fill: #3e2723;
    stroke: #795548;
    stroke-width: 1.2;
    animation: gb-crust-shimmer 3s ease-in-out infinite alternate;
  }

  @keyframes gb-crust-shimmer {
    0% { filter: drop-shadow(0 0 2px #4a148c); }
    100% { filter: drop-shadow(0 0 6px #ba68c8); }
  }
      ...
      <div class="gb-box">
        <div class="gb-stage">
          <svg class="gb-svg" viewBox="0 0 76 72">
            ...
            <!-- Inward-Facing Amethyst Quartz Druse Terminations -->
            <g class="gb-amethyst">
