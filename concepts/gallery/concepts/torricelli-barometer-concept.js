const torricelliBarometerStyles = `
  ...
  .tb-mercury-column {
    ...
    animation: tb-column-breathe 2.2s ease-in-out infinite alternate;
  }
  ...
  .tb-meniscus {
    animation: tb-meniscus-ride 2.2s ease-in-out infinite alternate;
  }
  ...
  .tb-torricelli-vacuum {
    animation: tb-vacuum-gleam 2.2s ease-in-out infinite alternate;
  }

  @keyframes tb-vacuum-gleam {
    0% { opacity: 0.3; }
    100% { opacity: 0.9; filter: drop-shadow(0 0 4px #38bdf8); }
  }

  /* Atmospheric pressure arrows pushing down on cistern pool */
  .tb-pressure-vector {
    animation: tb-vector-pulse 1.4s ease-in-out infinite alternate;
  }

  @keyframes tb-vector-pulse {
    0% { transform: translateY(-2px); opacity: 0.5; }
    100% { transform: translateY(4px); opacity: 1; stroke: #38bdf8; }
  }
      ...
      <div class="tb-box">
        <div class="tb-stage">
          <svg class="tb-svg" viewBox="0 0 76 72">
            ...
            <g class="tb-pressure-vector" stroke="#60a5fa" stroke-width="1">
              <line x1="28" y1="44" x2="28" y2="53" />
              <path d="M 26 50 L 28 54 L 30 50" fill="none" />
              <line x1="48" y1="44" x2="48" y2="53" />
              <path d="M 46 50 L 48 54 L 50 50" fill="none" />
            </g>
            ...
            <rect class="tb-torricelli-vacuum" x="34" y="9" width="8" height="12" rx="3" fill="#0284c7" />

            <!-- Liquid Mercury Column Rising up Tube (760mm hydrostatic balance) -->
            <rect class="tb-mercury-column" x="34" y="22" width="8" height="34" fill="#e2e8f0" />
            <!-- Mercury Convex Meniscus -->
            <ellipse class="tb-meniscus" cx="38" cy="22" rx="4" ry="1.4" fill="#f8fafc" />
...
if (!customElements.get('concept-torricelli-barometer')) {
