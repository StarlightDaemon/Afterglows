const ekgStyles = `
  ...
  /* --- v2: a bedside monitor with physical scrolling waveform --- */
  .e2 {
    width: 122px;
    height: 74px;
    position: relative;
  ...
  .e2-glow {
    opacity: 1;
    filter: drop-shadow(0 0 5px var(--accent, #00cc00));
  }
  ...
  .e2-cursor {
    ...
    animation: ekg-blip-bounce 1.2s ease-in-out infinite;
  }

  @keyframes ekg-blip-bounce {
  ...
  .e2-heart {
    ...
    animation: e2-heart 1.2s ease-out infinite;
  }

  @keyframes e2-heart {
    0%, 55% { transform: scale(0.9); opacity: 0.7; }
    62% { transform: scale(1.55); opacity: 1; filter: drop-shadow(0 0 6px #00ff66); }
    72%, 100% { transform: scale(0.9); opacity: 0.7; }
  }
