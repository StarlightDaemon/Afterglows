const runicCompassStyles = `
  ...
  .rnc-outer-ring {
    ...
    animation: rnc-spin-ring 4s linear infinite;
  }
  ...
  /* Vegvisir 8-stave compass counter-rotating */
  .rnc-staves-rig {
    position: relative;
    width: 72px;
    height: 72px;
    ...
    align-items: center;
    justify-content: center;
    animation: rnc-stave-spin 3s linear infinite;
  }

  @keyframes rnc-stave-spin {
  ...
  /* Orbiting wayfinding geomagnetic spark traversing stave tips */
  .rnc-nav-spark {
    position: absolute;
    width: 5px;
    height: 5px;
    ...
    z-index: 7;
    animation: rnc-spark-orbit 3s linear infinite;
  }

  @keyframes rnc-spark-orbit {
...
class ConceptRunicCompass extends HTMLElement {
  ...
  connectedCallback() {
    this.shadowRoot.innerHTML = `
      ...
      <div class="rnc">
        <div class="rnc-nav-spark"></div>
        <div class="rnc-outer-ring"></div>

        <div class="rnc-staves-rig">
