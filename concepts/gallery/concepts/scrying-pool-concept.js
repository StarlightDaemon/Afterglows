const scryingPoolStyles = `
  ...
  /* A carved obsidian scrying font: a single liquid droplet strikes the still
     surface, exciting concentric ripples that reveal a glowing all-seeing eye
     manifesting in the liquid depths before dissolving back into darkness. */
  .scry {
    width: 114px;
    height: 100px;
    position: relative;
  ...
  /* Runic carving inscriptions around font rim */
  .scry-runes {
    position: absolute;
    inset: 4px;
    border-radius: 50%;
  ...
  /* Concentric water ripples radiating from impact */
  .scry-ripple {
    position: absolute;
    left: 50%;
    top: 50%;
  ...
  /* Submerged mystical eye manifesting in depths */
  .scry-eye {
    position: absolute;
    left: 50%;
    top: 50%;
