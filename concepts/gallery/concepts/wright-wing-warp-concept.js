const wrightWarpStyles = `
  ...
  .ww-left-wing-tip {
    ...
    animation: ww-warp-left 2.6s ease-in-out infinite alternate;
  }

  .ww-right-wing-tip {
    transform-origin: 38px 32px;
    animation: ww-warp-right 2.6s ease-in-out infinite alternate;
  }

  @keyframes ww-warp-left {
    0% { transform: skewY(-6deg) translateY(-2px); }
  ...
  .ww-rudder-yaw {
    ...
    animation: ww-yaw-turn 2.6s ease-in-out infinite alternate;
  }
  ...
  /* Hip-cradle actuator control cable shift */
  .ww-warp-cables {
    animation: ww-cable-tension 1.3s ease-in-out infinite alternate;
  }

  @keyframes ww-cable-tension {
    0% { stroke: #ffd700; opacity: 0.6; }
    100% { stroke: #ffffff; opacity: 1; filter: drop-shadow(0 0 1.5px #ffd700); }
  }
      ...
      <div class="ww-box">
        <div class="ww-stage">
          <svg class="ww-svg" viewBox="0 0 76 72">
            ...
            <!-- Spruce Center Struts -->
            <line x1="34" y1="22" x2="34" y2="42" stroke="#8d6e63" stroke-width="1.2" />
            <line x1="42" y1="22" x2="42" y2="42" stroke="#8d6e63" stroke-width="1.2" />
            <!-- Prone Pilot Hip-Cradle (Orville Wright Hip Sliding Cradle) -->
            <rect x="35" y="38" width="6" height="3" fill="#ffb300" stroke="#ffd700" stroke-width="0.5" />

            <!-- Warping Left Wing Panel (Opposing Angle of Attack) -->
            ...
            <!-- Warping Right Wing Panel (Opposing Angle of Attack) -->
            ...
            <!-- Interconnected Vertical Twin Rudder (Adverse Yaw Compensation) -->
