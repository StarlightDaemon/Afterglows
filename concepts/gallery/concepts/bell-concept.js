const bellStyles = `
  ...
  /* A tower bell in full swing: the bell rocks on its yoke, the
     clapper lags a beat behind and strikes at each extreme, throwing
     a sound ring from the rim. */
  .bell {
    width: 104px;
    height: 96px;
    position: relative;
  ...
  /* Everything below the pivot swings together. */
  .bell-swing {
    position: absolute;
    left: 50%;
    top: 12px;
  ...
  /* Bell profile: shoulder, waist and flared mouth via clip-path. */
  .bell-cup {
    position: absolute;
    left: -24px;
    top: 0;
  ...
  /* Clapper: hinged at the crown, lagging the bell's phase. */
  .bell-clapper {
    position: absolute;
    left: 0;
    top: 2px;
  ...
  /* Sound rings off alternating rim edges at each strike. */
  .bell-ring {
    position: absolute;
    top: 48px;
    width: 14px;
  ...
  /* Motion ticks beside the shoulders. */
  .bell-tick {
    position: absolute;
    top: 22px;
    width: 8px;
