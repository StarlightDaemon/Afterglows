...
function applyVisualStandardV2(root){
 ...
 const frame=root.querySelector('div');frame.classList.add('vs2-frame');frame.setAttribute('role','img');frame.setAttribute('aria-label',"Davis Quadrant Backstaff. A held observation keeps both vanes attached to their rays; directional light paths retain purposeful motion.");
