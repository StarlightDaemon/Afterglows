...
const visualStandardV2Styles=".vs2-frame{width:134px;height:128px;box-sizing:border-box}.vs2-frame [class$=\"-stage\"]{width:110px;height:102px}.vs2-frame svg[class$=\"-svg\"]{width:98px;height:94px}.vs2-frame [class$=\"-label\"]{left:4px;right:4px;bottom:4px;font-size:7px;line-height:1.15;text-align:center;letter-spacing:.2px}\n.cl-reel-spool{transform-origin:16px 16px;animation-duration:6s}.cl-drogue-bob{animation:none;transform:translate(54px,46px)}.cl-line-flow{stroke-dasharray:15.70796 15.70796;animation:vs2-log-line 6s linear infinite}@keyframes vs2-log-line{from{stroke-dashoffset:0}to{stroke-dashoffset:-62.83185}}\n@media(prefers-reduced-motion:reduce){*,*::before,*::after{animation:none!important;transition:none!important}.cl-reel-spool{transform:rotate(25deg)}.cl-drogue-bob{transform:translate(54px,46px)}}";
function applyVisualStandardV2(root){
 ...
 const frame=root.querySelector('div');frame.classList.add('vs2-frame');frame.setAttribute('role','img');frame.setAttribute('aria-label',"Chip Log & Knot Line. The reel turns on its own axle, a fixed chip meets its bridle, and the knotted line advances at the reel rim speed.");
