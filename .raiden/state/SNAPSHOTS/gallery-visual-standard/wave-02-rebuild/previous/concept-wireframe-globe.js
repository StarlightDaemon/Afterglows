...
const visualStandardV2Styles="\n.wg-scan{opacity:.35;filter:blur(.5px)}.wg-sphere{box-shadow:0 0 7px #0c04,inset 0 0 8px #0c02}\n@media(prefers-reduced-motion:reduce){*,*::before,*::after{animation:none!important;transition:none!important}.wg-mer.m1{transform:scaleX(1);opacity:.7}.wg-mer.m2{transform:scaleX(.72);opacity:.6}.wg-mer.m3{transform:scaleX(.35);opacity:.5}.wg-mer.m4{transform:scaleX(.08);opacity:.4}.wg-scan{display:none}}";
function applyVisualStandardV2(root){
 ...
 const frame=root.querySelector('div');frame.classList.add('vs2-frame');frame.setAttribute('role','img');frame.setAttribute('aria-label',"Wireframe Globe. Retained the green wire sphere; separated stable meridians and softened the scanning band.");
