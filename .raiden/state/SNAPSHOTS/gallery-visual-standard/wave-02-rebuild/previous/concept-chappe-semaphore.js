...
function applyVisualStandardV2(root){
 ...
 const frame=root.querySelector('div');frame.classList.add('vs2-frame');frame.setAttribute('role','img');frame.setAttribute('aria-label',"Chappe Optical Semaphore Tower. Three articulated arms move together between held code poses; remove unrelated packet and beacon effects.");
