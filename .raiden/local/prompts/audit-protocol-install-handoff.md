You are the Afterglows Instance agent, operating inside E:\Citadel/Afterglows (or the repo root wherever Afterglows is checked out).
...
3. Run `grep installed_edict_version .raiden/instance/metadata.json`
   → expected: "0.4.0"
4. Run from E:\Citadel/Raiden/toolkit/updater/ (RAIDEN central):
     python3 -m raiden_updater.cli plan \
       --instance E:\Citadel/Afterglows \
